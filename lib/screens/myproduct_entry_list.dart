...
import 'package:flex_kick/models/product_entry.dart';
import 'package:flex_kick/widgets/left_drawer.dart';
import 'package:flex_kick/screens/product_detail.dart';
import 'package:flex_kick/widgets/product_entry_card.dart';
...
class _MyProductEntryListPageState extends State<MyProductEntryListPage> {
  Future<List<ProductEntry>> fetchProducts(CookieRequest request) async {
    ...
    final response = await request.get('http://localhost:8000/json-userProduct/');
          ...
          if (snapshot.data == null) {
            ...
            if (!snapshot.hasData) {
              return const Column(
                children: [
                  Text(
                    'There are no products in the flex kick yet.',
